          ...
          fluidRow(
              column( width = 6,
                 box(
                   ...
                   br(),
                   a("Wharton Research Data Services: Compustat North America Security Monthly Database", href = "https://wrds-www.wharton.upenn.edu", style = "color:LightGray;"),
                   br(),
              ...
              column( width = 6,
                 box(
                     ...
                     background = "blue",
                     "This project was created by Bryson Parker '23 and Jeremiah Kohl '22. We would like to give a special thanks to Professor Whitworth and our classmates for their assistance and guidance on our project."
             )
           )
            )
          )
